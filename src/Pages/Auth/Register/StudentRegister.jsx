...
const StudentRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${Api}/student-auth/student-register`,
        payload,
        {
          headers: {
      ...
      if (response.status === 201) {
        navigate("/auth/register/student-otp", { state: { data: response.data, email: formValues.email } });
      }
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-5">
                  ...
                  <p className="text-gray-800 mt-4 text-xs font-medium text-center">
                    ...
                    <Link to="/auth/student-login" className="font-semibold text-blue-600">
                      SignIn
                    </Link>
                    .
                  </p>
